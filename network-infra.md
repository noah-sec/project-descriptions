...
<!-- TITLE -->
<h1 align=center>Enterprise Secure Network Infrastructure Deployment</h1>

<!-- INTRODUCTION -->
<p align=center><i>Designed a systemic upgrade for an enterprise network infrastructure, including vendor acquisition and constructing a budget request. Justified the business need for the upgrade using industry documentation and historic performance data. Sourced a specific Palo Alto Networks firewall appliance to fit the organization's environment.</i></p>
